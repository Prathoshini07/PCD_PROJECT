...
class MultiplyEqualsNode : public AssignmentStatementNode
{
private:

public:
    MultiplyEqualsNode(IdentifierNode *in, ExpressionNode *en);
    void Code(InstructionsClass &machineCode);
    void Interpret();
};
class DivideEqualsNode : public AssignmentStatementNode
{
private:

public:
    DivideEqualsNode(IdentifierNode *in, ExpressionNode *en);
    void Code(InstructionsClass &machineCode);
    void Interpret();
};
